...
namespace ABC266C
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (calc.calc_1(side[1][0], side[1][1], side) == calc.calc_1(side[3][0], side[3][1], side))
            {
                Console.WriteLine("No");
            }
            else
            {
                if (calc.calc_2(side[0][0], side[0][1], side) == calc.calc_2(side[2][0], side[2][1], side))
                    Console.WriteLine("No");
                else
        ...
        int calc_1(int x, int y, int[][] side)
        {
        ...
        int calc_2(int x, int y, int[][] side)
        {
